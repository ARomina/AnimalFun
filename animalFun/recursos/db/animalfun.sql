...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-07-2017 a las 14:34:20
...
INSERT INTO `adopcion` (`id`, `usuarioEntrega`, `idMascota`, `usuarioAdoptante`, `fecha`) VALUES
(1, 3, 13, 7, '2017-06-13 08:09:32'),
(2, 6, 19, 1, '2017-07-19 10:15:00');
...
INSERT INTO `cita` (`id`, `idMascota`, `mascotaCitada`, `moviliza`, `fecha`) VALUES
(1, 17, 14, NULL, '2017-06-13 15:15:00'),
(2, 16, 41, NULL, '2017-07-26 15:21:33');
...
(34, 1, 'Lucrecia', 2, 3, 18, 2, 6, NULL, '../recursos/img/fotosMascota/600x350gatobirmania.jpg', 'Una gata muy linda'),
(41, 1, 'Lucrecio', 2, 3, 3, 1, 3, NULL, '../recursos/img/fotosMascota/600x350gatobirmania.jpg', 'Otro gato muy lindo');
...
(2, 9, 'Un hermoso dia en la plaza', NULL, NULL, '2017-06-19 05:25:40'),
(3, 12, 'Mi humano me mima', NULL, NULL, '2017-06-20 00:01:00'),
(4, 13, 'Me la pase jugando', NULL, NULL, '2017-06-01 12:14:13'),
(5, 15, 'Quiero dormiiir', NULL, NULL, '2017-01-01 16:34:27'),
(6, 19, 'Soy un felino feliz', NULL, NULL, '2000-01-01 00:04:00'),
(7, 16, 'Que divertido', NULL, NULL, '2000-01-01 00:05:00'),
(8, 20, 'Estuvo genial el dia', NULL, NULL, '2000-01-01 00:06:00'),
(9, 28, 'Comida para pajaritos', NULL, NULL, '2000-01-01 00:07:00'),
(10, 22, 'Jugar con una bola de lana', NULL, NULL, '2000-01-01 00:08:00'),
(11, 26, 'Somos gatitos felices', NULL, NULL, '2000-01-01 00:09:00'),
(12, 21, 'Me aburro', NULL, NULL, '2000-01-01 00:10:00'),
(13, 31, 'Nadando y nadando', NULL, NULL, '2000-01-01 00:11:00'),
(14, 19, 'Jugando', NULL, NULL, '2000-01-01 00:12:00'),
(15, 18, 'Jugando mucho', NULL, NULL, '2000-01-01 00:13:00'),
(16, 17, 'Me encanta ser perro', NULL, NULL, '2000-01-01 00:14:00'),
(17, 23, 'Quiero mi comidaa', NULL, NULL, '2000-01-01 00:15:00'),
(18, 20, 'Los felinos mas lindos de este sitio web', NULL, NULL, '2000-01-01 00:16:00'),
(19, 16, 'Jugando con amigos en el parque', NULL, NULL, '2000-01-01 00:17:00'),
(20, 15, 'Jugando en casa', NULL, NULL, '2000-01-01 00:18:00'),
(21, 30, 'Nadaaaaando', NULL, NULL, '2000-01-01 00:19:00'),
(22, 15, 'No me gusta madrugar', NULL, NULL, '2000-01-01 00:20:00'),
(23, 11, 'Me gustan las peliculas', NULL, NULL, '2000-01-01 00:21:00'),
(24, 13, 'Adoro a mis humanos', NULL, NULL, '2000-01-01 00:22:00'),
(25, 16, 'Me encanta mi casa', NULL, NULL, '2000-01-01 00:23:00');
...
(2, 'mascota se hizo amigo de mascota2', '2017-05-02 01:00:00'),
(3, 'mascota3 salio con mascota4', '2017-03-14 02:00:00'),
(4, 'usuario2 ofrece cachorros', '2017-05-14 03:00:00');
...
INSERT INTO `seguimiento` (`id`, `usuario`, `mascota`, `fecha`) VALUES
(1, 7, 12, '2017-06-09 17:22:26'),
(2, 4, 14, '2017-07-12 19:20:33'),
(3, 14, 34, '2017-07-14 05:21:34'),
(4, 5, 34, '2017-07-15 10:18:25'),
(5, 1, 17, '2017-07-15 19:24:12'),
(6, 1, 24, '2017-07-12 11:11:06'),
(7, 1, 21, '2017-07-08 17:14:45'),
(8, 1, 10, '2017-07-22 05:32:40'),
(9, 1, 9, '2017-07-01 10:09:04');
...
(25, 1, 2, '2017-07-03 00:33:38'),
(26, 1, 2, '2017-07-03 00:39:02'),
(27, 1, 2, '2017-07-03 00:41:09'),
(28, 1, 2, '2017-07-03 00:43:57');
...
INSERT INTO `visita` (`usuario`, `mascota`, `fecha`) VALUES
(7, 13, '2017-07-14'),
(10, 30, '2017-07-20');
...
ALTER TABLE `seguimiento`
  ADD PRIMARY KEY (`id`,`usuario`,`mascota`),
  ADD KEY `seguimiento_ibfk_1` (`usuario`),
  ADD KEY `seguimiento_ibfk_2` (`mascota`);
...
--
ALTER TABLE `visita`
  ADD PRIMARY KEY (`usuario`,`mascota`,`fecha`),
  ADD KEY `mascota` (`mascota`);
...
--
ALTER TABLE `raza`
  MODIFY `id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1235;
--
...
--
ALTER TABLE `cita`
  ADD CONSTRAINT `cita_ibfk_1` FOREIGN KEY (`idMascota`) REFERENCES `mascota` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `cita_ibfk_2` FOREIGN KEY (`mascotaCitada`) REFERENCES `mascota` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `seguimiento`
  ADD CONSTRAINT `seguimiento_ibfk_1` FOREIGN KEY (`usuario`) REFERENCES `usuario` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `seguimiento_ibfk_2` FOREIGN KEY (`mascota`) REFERENCES `mascota` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `visita`
  ADD CONSTRAINT `visita_ibfk_1` FOREIGN KEY (`usuario`) REFERENCES `usuario` (`id`),
  ADD CONSTRAINT `visita_ibfk_2` FOREIGN KEY (`mascota`) REFERENCES `mascota` (`id`);
