...
function login(){
    ...
    if(validacionLogin()){
			$.ajax({
					...
					url: "http://animalFun.fun/animalFun/extras/procesaLogin.php", 
	                type: "POST",
	                ...
	                success: 
	                      function(data){
	                        if(data == "USUARIO VALIDO"){
        						...
        						setTimeout(function () {
								    window.location.href = "http://animalFun.fun/animalFun/vistas/secciones/login.php";
								}, 900);
	                        }
	                    }
