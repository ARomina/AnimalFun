...
var fechaNac = "";
	...
	function modificarDatosUsuario(){
		...
		if(validacionDatosModif()){
			...
			$.ajax({
					url: "http://animalFun.fun/animalFun/extras/modificacionDatosUsuario.php",
					type: "POST",
					data: {//"id": id,
					       "nombre": nombre, 
						   "apellido": apellido, 
					...
					success: function(data) {
						if(data == "OK"){
        					...
        					setTimeout(function () {
								window.location.href = "http://animalFun.fun/animalFun/vistas/usuarios/adminUsuario.php";
							}, 1200);
						}else{
							$("#myModal").modal("toggle");
