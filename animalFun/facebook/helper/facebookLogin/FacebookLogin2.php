...
class FacebookLogin
{
    ...
    function __construct($fallbackUrl = 'http://animalfun.fun/animalFun/facebook/facebookCallback2.php'){
    ...
    {
        $auxConfig = parse_ini_file( $_SERVER['DOCUMENT_ROOT'] .  "/animalFun/facebook/config/config.ini", true);
