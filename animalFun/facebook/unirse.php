		                    ...
		                    <div class="col-xs-12">
		                        ...
		                        <span><?php  ?></span>
							        <form class="sa-innate-form" action="" method="POST">
									            ...
									            <input type="text" name="usuario" class="form-control" id="usuario"  value="<?php echo $user;?>" required="" title="nombre del perfil" placeholder="usuario">
									            ...
									            <input type="text" name="nombre" class="form-control" id="nombre"  value="<?php echo $user2[0];?>" required="" title="nombre del perfil" placeholder="nombre">
									            ...
									            <input type="text" name="apellido" class="form-control" id="apellido"  value="<?php echo $user2[1];?>" required="" title="apellido del perfil" placeholder="apellido">
									            ...
									            <input type="text" name="correo" class="form-control" id="correo"  value="<?php echo $correo;?>" required="" title="correo" placeholder="correo">
									            ...
									            <input type="text" name="correo2" class="form-control" id="correo2"  value="<?php echo $correo;?>" required="" title="correo" placeholder="correo">
