...
function login(){
    ...
    if(validacionLogin()){
			$.ajax({
					...
					url: "http://localhost/ProgWeb2-app/extras/procesaLogin2.php", 
	                type: "POST",
	                ...
	                success: 
	                      function(data){
	                        if(data == "OK"){
	                    window.location.href = "http://localhost/ProgWeb2-app/loginExito.php"; 
	                       }else{
	                            window.location.href = "http://localhost/ProgWeb2-app/loginFail.php";
	                        }
	                    }
