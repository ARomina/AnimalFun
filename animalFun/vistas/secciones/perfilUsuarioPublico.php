<?php
  ...
  $sql = "SELECT id, nombre, apellido, correo, sexo, telefono, fechaNac, posicion, foto FROM usuario WHERE id = '$idUsuario'";
    ...
    <!-- Sección Perfil Dueño -->
      <div class="row">
            <div class="col-md-12 text-center">
               <h2 class="titulo-central">Perfil de <?php echo $nombre;?></h2>
            </div>
      </div>
      <div class="container">
        <div class="row">
       <!--   <div class="col-lg-4">
        ...
        <div class="row" style="margin-top: -20px;">
            <div class="col-md-12 text-center">
               <h2 class="titulo-central">Mascotas de <?php echo $nombre;?></h2>
            </div>
