<?php
  ...
  $sql = "SELECT m.nombre as nombre, m.foto as foto, e.descripcion as estado from mascota m JOIN estado e ON m.estado = e.id WHERE m.id = '$idMascota'";
...
<html lang="en-US">
  ...
  color: #ffffff;"><?php echo $estadoMascota;?></p>
                                  </div>
                              </div>
                            </div>
                            </div>
