...
<html lang="en-US">
   ...
   <body>
        ...
        <div class="row">
          <div class="col-md-4 center-block">
            ...
            <div class="form-group">
             <div class="col-md-12 text-center">
                <form action="../../extras/editarFotoPerfilMascota.php?idMascota=<?php echo $idMascota;?>" method="POST" enctype="multipart/form-data" class="center-block">
          ...
          <div class="col-md-8">
            <form class="form-horizontal" role="form">
                <fieldset>
                  ...
                  <legend>Datos</legend>
                    <input type="hidden" value="<?php echo $idMascota;?>" id="idMascota" />
          ...
          <div class="form-group">
           ...
           <!--      <button type="submit" class="btn btn-default">Cancel</button> -->
                <button type="button" class="btn boton2" onClick="modificarDatosMascota()">Modificar datos</button>
              </div>
            </div>
          </div>
      </div><!-- div container -->
    ...
    <script type="text/javascript" src="../../recursos/js/modificarDatosMascota.js"></script>
       <!-- /.container -->
