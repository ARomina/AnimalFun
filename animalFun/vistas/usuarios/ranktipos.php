...
$SQLDatos = "SELECT  tipo.descripcion, COUNT(*) AS cantidad FROM mascota join tipo on mascota.tipo=tipo.id GROUP BY tipo.descripcion";
...
<div id="donutchart" style="width: 370px; height: 370px"></div>
</div>
</body>
</html>