<?php
  ...
  $idPost = $_GET['idPost'];
  $idMascotaPost = $_GET['idMascotaPost'];

  /*$idMascota = $_GET['idMascota'];*/

  //Query para traer el nombre de la mascota
  $sql = "SELECT nombre, foto from mascota WHERE id = '$idMascotaPost'";
       ...
       <div class="row">
           <!-- Columna derecha -->
                    <div class="col-lg-4">
                      <div class="widget-sidebar">     
                        <?php include("../../extras/infoMascotaPost.php");?>

                        <?php 

                          $sql = "SELECT count(*) FROM seguimiento s WHERE s.mascota = '$idMascotaPost'";
                                  ...
                                  if($row[0] == 0){
                                    ...
                                    echo '<h2 class="title-widget-sidebar">Seguidores <span class="label label-warning label-as-badge">'.$row[0].'</span></h2>
                                          <div class="content-widget-sidebar">
                                            <div class="center-block">
                                              <ul style="list-style: none; padding-left: 0;">';
                                                include("../../extras/infoMascotaSeguidoresPost.php");
                                              echo '</div>
                                          </div>';
        ...
        <div class="col-lg-4">
          <div class="row">
                            ...
                            <?php include("../../extras/contenidoPostMascota.php");?>
                            
                            <div class="col-lg-12 col-md-12">
                              <aside>
                               <div class="widget-sidebar">
                                  <h2 class="title-widget-sidebar">Comentarios </h2>
                                    <div class="row">
                                      <div class="col-lg-12 col-md-12">
                                       <div class="content-widget-sidebar">
          ...
          <!-- Columna izquierda -->
                  <div class="col-lg-4">
                    <div class="row">           
                      <div class="widget-sidebar">
                        <h2 class="title-widget-sidebar">Tu comentario </h2>
                          <div class="row">
                            <div class="col-lg-12 col-md-12">
                             <div class="content-widget-sidebar">
                                  <form action="" method="POST">
                                    <textarea rows="5" placeholder="Escribe tu comentario aqui..."></textarea>
                                    <hr>
                                    <div class="pull-right">
                                      <button type="submit" class="btn boton4">Comentar</button>
                                    </div>
                                  </form>
                              </div>
                            </div>
