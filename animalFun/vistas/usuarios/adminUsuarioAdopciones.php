    ...
    <!-- Sección -->
      <div class="row">
            <div class="col-md-12 text-center">
               <h2 class="titulo-central">Mis mascotas en adopción</h2>
            </div>
      </div>
      ...
      <div class="row">
            ...
            <br>
              <div class="divFotosMascotas">
                    <ul class="fotos-Polaroid fotosMascotas">
                      <?php include("../../extras/verMascotasEnAdopcionUsuario.php");?>
                    </ul>
                </div>
                <br>
            </div>
         ...
         <div class="row">
            <div class="col-md-12 text-center">
               <h2 class="titulo-central">Mis mascotas adoptadas</h2>
            </div>
      </div>
      ...
      <div class="row">
          <div class="col-md-12">
            <br>
              <div class="divFotosMascotas">
                    <ul class="fotos-Polaroid fotosMascotas">
                      <?php include("../../extras/verMascotasAdoptadasUsuario.php");?>
                    </ul>
                </div>
                <br>
            </div>
