              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <div class="pull-right">
                    ...
                    <button type="button" id="botonAgregarMascota" class="btn boton2 textoBoldBlanco" onclick="validacionRegistroMascota()">Agregar mascota <i class="fa fa-plus" aria-hidden="true" id="icono"></i></button>
                  </div>
                </div>
              </div>
