<?php 
	...
	$sql = "SELECT m.id AS idMascota, m.nombre, t.descripcion AS tipo, ta.descripcion AS tamano, r.descripcion AS raza, s.descripcion AS sexo, e.descripcion AS 		estado, foto AS fotoMascota, caracteristicas FROM mascota m
